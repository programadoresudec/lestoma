...
[assembly: ExportRenderer(typeof(lestoma.App.Controls.NullableTimePicker), typeof(NullableTimePickerRenderer))]
namespace lestoma.App.Droid
{
    public class NullableTimePickerRenderer : ViewRenderer<Controls.NullableTimePicker, EditText>
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == Controls.NullableTimePicker.NullableTimeProperty.PropertyName && Control != null && Element != null)
            {
                Control.Text = !Element.NullableTime.HasValue ? Element.PlaceHolder : DateTime.Today.Add(Element.NullableTime.Value).ToString(Element.Format);
            }
